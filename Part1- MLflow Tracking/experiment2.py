...
def run_model(experiment_id, params):
    ...
    with mlflow.start_run(experiment_id=experiment_id,
                          run_name=params["run_name"]) as run:
...
experiment_instance = mlflow.get_experiment_by_name("My experiment")
experiment_id = experiment_instance.experiment_id

params_list = [{'run_name': "run_name_1", 'epochs': 1, 'convSize': 2},
               {'run_name': "run_name_2", 'epochs': 10, 'convSize': 3}]
